...
<!-- This is used to delete a class from the database. This also looks very similar to deleteFaculty.php and deleteStudent.php.-->
...
$result = mysqli_query($mysqli, "DELETE FROM class WHERE id=$id");
