...
<!-- This is used to add a professor from the database. This also looks very similar to addStudent.php and addClass.php.-->
...
<html lang = "en">
    ...
    <section class="engine"></a></section><section class="tabs3 cid-rpZOWSJbS0" id="tabs3-6">
        ...
        <form action="addFaculty.php" method="post" name="form2">
            <table>
                <tr>
                    <td>Name</td>
    ...
    if(isset($_POST['Submit']))
    {
        ...
        $addFacultyResultQuery = mysqli_query($mysqli, "INSERT INTO professor(name,office,phone,email,username, password) 
                                VALUES ('$name','$office','$phone','$email','$uN','$pW')");
