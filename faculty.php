...
<section class="engine"></a></section><section class="tabs3 cid-rpZOWSJbS0" id="tabs3-6">
    <div class="container">
        <h2 class="mbr-section-title align-center pb-3 mbr-fonts-style display-2">
            Faculty in the CS Department</h2>
        <h3 class="mbr-section-subtitle  display-5 align-center mbr-light mbr-fonts-style">
            As an Admin here, you are given two options. You can either view all the current faculty members (you are granted access to also change and/or delete) that work within
            the department. Or, you can add a new faculty member into the record.</h3>
    </div>
    <div class="container-fluid">
        <div class="row tabcont">
            <ul class="nav nav-tabs pt-3 mt-5" role="tablist">
                <li class="nav-item mbr-fonts-style"><a class="nav-link active display-7" role="tab" data-toggle="tab" href="http://localhost/410webapp/viewFaculty.php">
                        View</a></li>
                <li class="nav-item mbr-fonts-style"><a class="nav-link  active show display-7" role="tab" data-toggle="tab" href="http://localhost/410webapp/addFaculty.php" aria-selected="true">
                        Add</a></li>
            </ul>
        </div>
    </div>
