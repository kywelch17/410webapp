...
<section class="engine"></a></section><section class="tabs3 cid-rpZOWSJbS0" id="tabs3-6">
    <table>
        <tr>
            <u><th>Name</th> <th>Office</th> <th>Phone Number</th> <th>Email</th> <th>Update</th></u>
        </tr>
        <?php
        while($user_data = mysqli_fetch_array($resultQuery))
        {
            ...
            echo "<td><button><a href='editFaculty.php?id=$user_data[id]'>Edit</a></button><button><a href='deleteFaculty.php?id=$user_data[id]'>Delete</a></button></td></tr>";
        }
        ?>
    </table>
</body>
